...
$string['create_nivel2'] = 'Crear nuevo Plan';
$string['update_nivel2'] = 'Actualizar Plan';
$string['create_nivel3'] = 'Crear nuevo Curso';
$string['update_nivel3'] = 'Actualizar Curso';
$string['create_nivel4'] = 'Crear nuevo Curso Asignado';
$string['update_nivel4'] = 'Actualizar Curso Asignado';
$string['create_dato1'] = 'Crear nueva Sede';
$string['update_dato1'] = 'Actualizar Sede';
